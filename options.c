...
struct fio_option fio_options[FIO_MAX_OPTS] = {
	...
	{
		.name	= "issue_zone_finish",
		.lname	= "Issue finish",
		.type	= FIO_OPT_BOOL,
		.maxlen	= 1,
		.off1	= offsetof(struct thread_options, issue_zone_finish),
		.help	= "Issue finish when the zone is full",
		.def	= "0",
		.category = FIO_OPT_C_IO,
		.group	= FIO_OPT_G_ZONE,
	},
	{
		.name	= "fill_empty_zones_first",
		.lname	= "fill empty zones first",
		.type	= FIO_OPT_BOOL,
		.maxlen	= 1,
		.off1	= offsetof(struct thread_options, fill_empty_zones_first),
		.help	= "Fill empty zones before resetting zones",
		.def	= "0",
		.category = FIO_OPT_C_IO,
		.group	= FIO_OPT_G_ZONE,
	},
	{
		.name	= "reset_all_zones_first",
		.lname	= "reset all zones first",
		.type	= FIO_OPT_BOOL,
		.maxlen	= 1,
		.off1	= offsetof(struct thread_options, reset_all_zones_first),
		.help	= "Reset all zones at start of job",
		.def	= "0",
		.category = FIO_OPT_C_IO,
		.group	= FIO_OPT_G_ZONE,
	},
	{
		.name	= "reset_active_zones_first",
		.lname	= "reset active zones first",
		.type	= FIO_OPT_BOOL,
		.maxlen	= 1,
		.off1	= offsetof(struct thread_options, reset_active_zones_first),
		.help	= "Reset active zones at start of job",
		.def	= "0",
		.category = FIO_OPT_C_IO,
		.group	= FIO_OPT_G_ZONE,
	},
	{
		.name	= "finish_zone_pct",
		.lname	= "finish zone percentage",
		.type	= FIO_OPT_INT,
		.maxlen	= 1,
		.off1	= offsetof(struct thread_options, finish_zone_pct),
		.help	= "percentage of zonesize to issue zone finish",
		.def	= "100",
		.category = FIO_OPT_C_IO,
		.group	= FIO_OPT_G_ZONE,
	},
	...
	{
		.name	= "exp_commit",
		.lname	= "Zone explicit commit",
		.type	= FIO_OPT_INT,
		.maxlen	= 1,
		.off1	= offsetof(struct thread_options, exp_commit),
		.help	= "Issue zone commit explicitly",
		.def	= "0",
		.category = FIO_OPT_C_IO,
		.group	= FIO_OPT_G_ZONE,
	},
	{
		.name	= "zrwa_overwrite_percent",
		.lname	= "Overwrite percentage wrt zone capacity",
		.type	= FIO_OPT_INT,
		.maxlen	= 1,
		.off1	= offsetof(struct thread_options, zrwa_overwrite_percent),
		.help	= "Amount of overwrites as a percentage of zone capacity",
		.def	= "0",
		.category = FIO_OPT_C_IO,
		.group	= FIO_OPT_G_ZONE,
	},
        {
                .name   = "zrwa_rand_ow",
                .lname  = "Overwrite randomly",
                .type   = FIO_OPT_INT,
                .maxlen = 1,
                .off1   = offsetof(struct thread_options, zrwa_rand_ow),
                .help   = "Overwrites lbas randomly in a zone",
                .def    = "0",
                .category = FIO_OPT_C_IO,
                .group  = FIO_OPT_G_ZONE,
       },
	{
		...
		.type	= FIO_OPT_INT,
		.maxlen	= 1,
		.off1	= offsetof(struct thread_options, zrwa_alloc),
	...
	},
	{
		...
		.type	= FIO_OPT_INT,
		.maxlen	= 1,
		.off1	= offsetof(struct thread_options, dynamic_qd),
		.help	= "Dynamically manage qd to ZRWA region",
		.def	= "1",
		.category = FIO_OPT_C_IO,
		.group	= FIO_OPT_G_ZONE,
	},
